...
if __name__ == "__main__": 
    ...
    main_window = MainApp(microscope=microscope, position_grid=position_grid, camera=micro_cam,parameters=parameters, export=export, special_mode= "LED", video = False)
